...
export default function ChatPage() {
  ...
  const { isOpen, debugData, setDebugData, togglePanel } = useDebugData();
  ...
  const handleSendMessage = async (messageContent: string) => {
    try {
      ...
      const requestBody: {
        ...
        includeContext: true,
        debugMode: isOpen, // Include debug data when panel is open
      };
  ...
  return (
    <div className="flex h-full">
      ...
      <DebugPanel debugData={debugData} isOpen={isOpen} onToggle={togglePanel} />
    </div>
  );
}
